...
const anchorId = (str, transformOption) => {
	return slugize(stripHTML(unescape(str)).trim(), {
...
module.exports = function(data, options) {
	...
	this.execFilterSync('marked:renderer', renderer, {
		context: this
	});

	const tokenizer = new Tokenizer();
	this.execFilterSync('marked:tokenizer', tokenizer, {
		context: this
	});

	const extensions = [];
	this.execFilterSync('marked:extensions', extensions, {
		context: this
	});
	marked.use({
		extensions
